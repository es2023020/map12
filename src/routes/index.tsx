...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "PropTrack — Real-Estate Intelligence for Egyptian Brokers",
      },
      {
    ...
    <Shell>
      <section className="relative overflow-hidden bg-primary text-primary-foreground">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse at 20% 0%, oklch(0.72 0.12 195 / .5), transparent 50%), radial-gradient(ellipse at 80% 100%, oklch(0.7 0.18 40 / .4), transparent 60%)",
          }}
        />
          ...
          <div>
            <div className="flex items-center gap-3">
              <img
                src="/logo.png"
                alt="PropTrack"
                className="h-11 w-11 sm:h-14 sm:w-14 object-contain drop-shadow-xl shrink-0"
              />
            ...
            <p className="mt-4 max-w-lg text-base sm:text-lg text-primary-foreground/80 leading-relaxed">
              PropTrack is the real-estate intelligence platform for the Egyptian market — Sahel,
              New Cairo, and Sheikh Zayed, mapped in one place.
            </p>
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              ...
              >
                <Button
                  size="lg"
                  className="w-full sm:w-auto rounded-full bg-accent text-accent-foreground hover:bg-accent/90 h-12 px-6 text-sm font-bold"
                >
              ...
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto rounded-full border-white/30 bg-transparent text-white hover:bg-white/10 hover:text-white h-12 px-6 text-sm font-semibold"
                >
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:py-14 lg:px-8">
        <SectionHeader
          ...
          subtitle="From Sidi Heneish to Tagamo3."
      ...
      <section className="bg-gradient-sand">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:py-14 lg:px-8">
          <SectionHeader
            ...
            subtitle="Hand-picked launches and benchmarks."
          ...
          {[
            {
              ...
              body: "Every project pinned, filterable by destination, developer, price and delivery year. Smooth as Google Maps, branded for brokers.",
            },
            {
              icon: Building2,
              title: "Compound deep-dives",
              body: "Developer, payment plan, unit mix, amenities and a mini-map — everything your client asks for in one page.",
            },
            {
              icon: Users,
              title: "Broker workspace",
              body: "Lead pipeline, favorites, side-by-side compare, and tier-based subscriptions.",
            },
          ].map((v) => (
            <div
              key={v.title}
              className="rounded-2xl border border-border/60 bg-card p-5 sm:p-6 shadow-soft"
            >
              <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-accent/15 text-accent">
                <v.icon className="h-5 w-5" />
              </div>
              <h3 className="mt-4 font-display text-lg sm:text-xl font-semibold text-primary">
                {v.title}
              </h3>
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[1.4fr_1fr]">
            <div>
              <h2 className="font-display text-2.5xl sm:text-3xl md:text-4xl font-semibold leading-tight">
                Stop juggling brochures.
                <br className="hidden sm:inline" /> Start closing.
              </h2>
              <p className="mt-3 max-w-lg text-sm sm:text-base text-primary-foreground/80">
                Get the broker dashboard, full project library, and the interactive map — built
                specifically for Egypt.
              </p>
            </div>
  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-3">
      ...
      {link && (
        <Link
          to={link.to as any}
          className="group inline-flex items-center gap-1 text-sm font-medium text-accent hover:text-primary"
        >
          {link.label}{" "}
