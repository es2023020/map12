          ...
          <div className="max-w-lg w-full bg-card border border-border rounded-3xl p-8 sm:p-10 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="mx-auto w-20 h-20 rounded-2xl bg-gradient-to-br from-accent/20 to-primary/10 border border-accent/30 flex items-center justify-center text-accent shadow-inner">
                <MapIcon className="h-10 w-10 animate-pulse" />
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-md mx-auto">
                  Our interactive GIS masterplan map with compound coordinates, zones, and spatial intelligence will be available here soon.
                </p>
              </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Link
                  to="/dashboard"
                  className="px-6 py-2.5 rounded-full border border-border bg-card text-foreground text-xs font-bold hover:bg-secondary transition-colors"
                >
                  Go to Dashboard
                </Link>
              </div>
