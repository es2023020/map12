...
export const compoundRegistry: Record<string, CompoundRegistryEntry> = {
  ...
  "hacienda-west": {
    destination: "ras-el-hekma",
    km: 208,
    city: "Ras El Hekma, North Coast (km 208–240), Matrouh Governorate, Egypt",
    lat: 31.0921,
    lng: 27.9532,
    developer: "Palm Hills Developments",
    beachfront: true,
    type: "Resort",
    blurb: "Hacienda West is Palm Hills' luxury low-density coastal community spanning approximately 116 feddans. The project offers contemporary architecture, landscaped open spaces, and direct access to Ras El Hekma beach.",
    paymentPlan: "10% down, installments up to 5 years",
    amenities: ["Private beach", "Beach club", "Clubhouse", "Swimming pools", "Crystal lagoons", "Gym & spa", "Restaurants & cafés", "Commercial area", "Sports courts", "Kids' play areas", "24/7 security"],
    types: ["Cabin", "Chalet", "Townhouse", "Twin House", "Standalone Villa"],
    highlights: ["Boutique luxury resort", "116 feddan low-density compound", "Seamless indoor-outdoor living", "Fastest growing Sahel destination"]
  },
  "hacienda-white": {
    destination: "sidi-abdelrahman",
    km: 140,
