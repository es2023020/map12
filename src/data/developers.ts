...
const blurbs: Record<string, string> = {
  ...
  "Wadi Degla": "Zahra, Zayed 2000, Murano Ain Sokhna — North Coast, New Alamein and Red Sea coastal communities.",
  ...
  "Orascom Development": "El Gouna Red Sea, Makadi Heights, O West Sheikh Zayed, Byoum Lakeside Fayoum — Orascom's integrated resort cities and urban communities across Egypt.",
...
const logoMap: Record<string, string> = {
  ...
  "dunes-development": "https://ui-avatars.com/api/?background=4a5d6e&color=fff&bold=true&size=128&name=Dunes",
  "arkan-palm": "https://ui-avatars.com/api/?background=123456&color=fff&bold=true&size=128&name=Arkan+Palm",
  "rmc-developments": "https://ui-avatars.com/api/?background=789abc&color=fff&bold=true&size=128&name=RMC",
  "g-developments": "https://ui-avatars.com/api/?background=def012&color=fff&bold=true&size=128&name=G+Dev",
