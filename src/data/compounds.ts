...
const newProjects: Compound[] = [
  ...
  },
  {
    ...
    type: "Residential",
    highlights: [
      "Gateway of New Heliopolis (1 min to Suez Rd)",
      "85% green spaces & water features (15% footprint)",
      "Targeted delivery December 2029",
      "466 apartments & private villas",
    ],
  },
  {
    slug: "rock-white",
    ...
    type: "Residential",
    highlights: [
      "Prime position on Baron Axis (1 min to Suez Rd)",
      "90% open space & water features (10-15% footprint)",
      "12,000 m² commercial strip & private cinema",
  ...
  },
  {
    ...
    types: ["Apartment"],
    amenities: [
      "2-Level Underground Parking (700+ cars)",
      "Indoor Game & Event Hall",
      "Private Home Cinema",
      "Book Café",
      "Spa & Workout Area",
      "EV Chargers",
    ...
    type: "Residential",
    highlights: [
      "Sheraton Heliopolis prime location (5 mins to Airport)",
      "English courtyard theme with G+4 blocks",
      "2-level underground garage for 700+ cars",
      "Private cinema, book café & EV chargers",
    ],
  },
  {
    slug: "rock-eden",
    ...
    amenities: [
      "20,000+ m² Commercial Strip",
      "Structured Sports Club",
      "Swimming Pools",
    ...
    paymentPlan: "Ready to Move · flexible payment terms",
    areaSize: "34 feddan",
    unitSizes: "160–327 m²",
    type: "Residential",
    highlights: [
      "Delivered active community on Ahmed Zewail St",
      "1 min to Zewail City & 2 mins to Magdi Yacoub Center",
      "20,000+ m² commercial strip & sports club",
      "859 apartments + 87 townhouse villas",
    ],
  },
  {
    slug: "rock-vera",
    ...
    types: ["Apartment", "Penthouse"],
    amenities: [
      "5,500 m² Commercial Strip",
      "Private Home Cinema",
      "Book Café",
      "Arts & Crafts Rooms",
      "Business Center",
      "Gym & Spa",
      "800m Jogging & Cycling Track",
      "24/7 Security",
    ],
    hero: modernApartImgs[0],
    gallery: [modernApartImgs[0]],
    ...
    type: "Residential",
    highlights: [
      "Delivered & populated RTM community",
      "Italian-themed architecture with 27 G+3 blocks",
      "5,500 m² commercial & lifestyle strip",
      "800m jogging track & 75% greenery",
    ],
  },
  {
    slug: "rock-gold",
  ...
  // ══════════════════════════════════════════
  // SKY AD DEVELOPMENTS (SKY ABU DHABI)
  // ══════════════════════════════════════════
  {
    slug: "bluetree",
    ...
    developerSlug: "sky-ad-developments",
    priceFrom: 6.04,
    deliveryYear: 2028,
    status: "Off-Plan",
    beachfront: false,
