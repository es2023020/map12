...
const sahelRaw: SahelInput[] = [
  ...
  ["Gaia", 140, "sidi-abdelrahman", "Tatweer Misr", 9, 2026, true],
  ...
  ["D-Bay", 190, "ras-el-hekma", "Wadi Degla", 7, 2026, true],
...
const extraRaw: Array<{
  ...
  { name: "Marbay", area: "ain-sokhna", lat: 29.618, lng: 32.315, developer: "Eagle Hills", price: 12, year: 2027, beach: true, type: "Resort" },
