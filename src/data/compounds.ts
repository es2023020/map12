...
const newProjects: Compound[] = [
  ...
  },
  {
    ...
    status: "Off-Plan",
    beachfront: true,
    types: ["Standalone Villa", "Chalet", "Apartment"],
    amenities: ["Clubhouse", "Swimming Pools", "Gym & Spa", "24/7 Security", "Green Spaces", "Commercial Strip"],
    hero: "/projects/hacienda-west/1.jpg",
    gallery: ["/projects/hacienda-west/1.jpg", "/projects/hacienda-west/2.jpg"],
    blurb: "Hacienda West is a premium development by Palm Hills Developments in Sidi Abdelrahman, presenting high-end unit designs and world-class compound amenities.",
    paymentPlan: "10% down · 7 years equal installments",
    areaSize: "100 feddan",
    unitSizes: "80–300 m²",
    type: "Resort",
    highlights: ["Hacienda West prime location", "Palm Hills Developments signature design", "Premium amenities & spaces", "Ready by 2028"],
  },
  {
