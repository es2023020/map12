...
try {
  execSync('git checkout src/data/compounds.ts src/data/project-locations.ts src/data/sahel-details.ts', { stdio: 'inherit' });
} catch (e) {
...
compCode = compCode.replace(/\s*\["Sky North",\s*246,\s*"sidi-heneish",\s*"Sky AD\. Developments",\s*11,\s*2029,\s*false\],?\n?/g, '\n');
compCode = compCode.replace(/\s*\["Summer",\s*246,\s*"sidi-heneish",\s*"Al Ahly Sabbour",\s*9,\s*2026,\s*true\],?\n?/g, '\n');
...
compCode = compCode.replace(blueBlockRegex, `{
    slug: "hacienda-blue",
    name: "Hacienda Blue",
...
compCode = compCode.replace(alamRoumStaticRegex, `{
    slug: "alam-al-roum",
    name: "Alam Al Roum",
...
compCode = compCode.replace(jamilaStaticRegex, `{
    slug: "jamila",
    name: "Jamila",
    destination: "sidi-heneish",
...
compCode = compCode.replace(haciendaHeneishStaticRegex, `{
...
compCode = compCode.replace(silversandsStaticRegex, `{
    slug: "silversands",
    name: "Silversands",
    destination: "sidi-heneish",
...
compCode = compCode.replace(marsaBaghushStaticRegex, `{
    slug: "marsa-baghush",
    name: "Marsa Baghush",
    destination: "sidi-heneish",
...
compCode = compCode.replace(beitAlBahrStaticRegex, `{
    slug: "beit-al-bahr",
    name: "Beit Al Bahr",
    destination: "sidi-heneish",
    lat: 31.20, lng: 27.63,
...
const locUpdates = {
  "alam-al-roum": { name: "Alam Al Roum", destination: "sidi-heneish", location: "East of Marsa Matrouh, North Coast, Egypt", mapsUrl: "https://www.google.com/maps/place/Alam+el+Rum+resort/@31.3552324,27.3489873" },
  "jamila": { name: "Jamila", destination: "sidi-heneish", location: "Sidi Heneish, North Coast, Egypt", mapsUrl: "https://maps.google.com/?q=Jamila+North+Coast+Sidi+Heneish" },
  "hacienda-heneish": { name: "Hacienda Heneish", destination: "sidi-heneish", location: "Sidi Heneish, North Coast, Egypt", mapsUrl: "https://maps.google.com/?q=Hacienda+Heneish+Palm+Hills" },
  "silversands": { name: "Silversands", destination: "sidi-heneish", location: "Sidi Heneish, North Coast, Egypt", mapsUrl: "https://maps.google.com/?q=Silver+Sands+Ora+Sidi+Heneish" },
  "marsa-baghush": { name: "Marsa Baghush", destination: "sidi-heneish", location: "Sidi Heneish, North Coast, Egypt", mapsUrl: "https://maps.google.com/?q=Marsa+Baghush+Sidi+Heneish" },
  "beit-al-bahr": { name: "Beit Al Bahr", destination: "sidi-heneish", location: "Sidi Heneish, North Coast, Egypt", mapsUrl: "https://maps.google.com/?q=Beit+El+Bahr+Sidi+Heneish" },
  "hacienda-blue": { name: "Hacienda Blue", destination: "ras-el-hekma", location: "Ras El Hekma, North Coast, Egypt", mapsUrl: "https://maps.google.com/?q=Hacienda+Blue+North" }
};
...
sahelCode = sahelCode.replace(/silversands\s*:\s*\{[\s\S]*?\},\s*\n/g, `silversands: ${JSON.stringify(sahelUpdates.silversands, null, 2)},\n`);
